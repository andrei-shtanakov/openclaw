...
describe("subtitleForTab", () => {
  ...
  it("returns descriptive subtitles", () => {
    ...
    expect(subtitleForTab("config")).toContain("orchid.json");
  });
});
...
describe("normalizeBasePath", () => {
  it("normalizes base-path variants", () => {
    const cases = [
      ...
      { input: "/ui/", expected: "/ui" },
      { input: "/", expected: "" },
      { input: "/apps/orchid", expected: "/apps/orchid" },
    ] as const;
    for (const testCase of cases) {
...
describe("pathForTab", () => {
  it("builds tab paths with optional bases", () => {
    const cases = [
      ...
      { tab: "sessions", base: "/apps/orchid", expected: "/apps/orchid/sessions" },
    ] as const;
    for (const testCase of cases) {
      expect(
...
describe("tabFromPath", () => {
  it("resolves tabs from path variants", () => {
    const cases = [
      ...
      { path: "/apps/orchid/sessions", base: "/apps/orchid", expected: "sessions" },
...
describe("inferBasePathFromPathname", () => {
  it("infers base-path variants from pathname", () => {
    const cases = [
      ...
      { path: "/apps/orchid/sessions", expected: "/apps/orchid" },
