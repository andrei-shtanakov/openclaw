...
export function renderOverview(props: OverviewProps) {
  ...
  const authHint = (() => {
      ...
      return html`
        <div class="muted" style="margin-top: 8px">
          ...
          <div style="margin-top: 6px">
            <span class="mono">orchid dashboard --no-open</span> → tokenized URL<br />
            <span class="mono">orchid doctor --generate-gateway-token</span> → set token
          </div>
          <div style="margin-top: 6px">
            <a
              class="session-link"
    ...
    return html`
      <div class="muted" style="margin-top: 8px">
        ${t("overview.auth.failed", { command: "orchid dashboard --no-open" })}
        <div style="margin-top: 6px">
          <a
            class="session-link"
            href="https://docs.orchid.ai/web/dashboard"
    ...
    return html`
      <div class="muted" style="margin-top: 8px">
        ...
        <div style="margin-top: 6px">
          <a
            class="session-link"
            href="https://docs.orchid.ai/gateway/tailscale"
            target="_blank"
            rel="noreferrer"
          ...
          <a
            class="session-link"
            href="https://docs.orchid.ai/web/control-ui#insecure-http"
            target="_blank"
            rel="noreferrer"
              ...
              : html`
                <label class="field">
                  ...
                  <input
                    ...
                    placeholder="ORCHID_GATEWAY_TOKEN"
                  />
                </label>
                <label class="field">
                ...
                <div style="margin-top: 16px; border-top: 1px solid var(--border); padding-top: 14px;">
                  ...
                  <ol class="muted" style="margin: 0; padding-left: 18px; font-size: 13px; line-height: 1.8;">
                    <li>${t("overview.connection.step1")}
                      <div class="mono" style="font-size: 12px; margin: 4px 0 6px;">orchid gateway run</div>
                    </li>
                    <li>${t("overview.connection.step2")}
                      <div class="mono" style="font-size: 12px; margin: 4px 0 6px;">orchid dashboard --no-open</div>
                    </li>
                    <li>${t("overview.connection.step3")}</li>
                    <li>${t("overview.connection.step4")}
                      <div class="mono" style="font-size: 12px; margin: 4px 0 6px;">orchid doctor --generate-gateway-token</div>
                    </li>
                  </ol>
