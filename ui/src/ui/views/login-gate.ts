    ...
    <div class="login-gate">
      ...
      <div class="login-gate__card">
        <div class="login-gate__header">
          <img class="login-gate__logo" src=${faviconSrc} alt="Orchid" />
          <div class="login-gate__title">Orchid</div>
        ...
        <div class="login-gate__help">
          ...
          <ol class="muted" style="margin: 0; padding-left: 16px; font-size: 12px; line-height: 1.7;">
            <li>${t("overview.connection.step1")}
              <div class="mono" style="font-size: 11px; margin: 2px 0 4px;">orchid gateway run</div>
            </li>
            <li>${t("overview.connection.step2")}
              <div class="mono" style="font-size: 11px; margin: 2px 0 4px;">orchid dashboard --no-open</div>
            </li>
