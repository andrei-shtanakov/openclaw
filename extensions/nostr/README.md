...
Nostr DM channel plugin for Orchid using NIP-04 encrypted direct messages.

## Overview

This extension adds Nostr as a messaging channel to Orchid. It enables your bot to:
...
# Configure orchid to use local relay
