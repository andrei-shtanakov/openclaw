...
This directory contains the **BlueBubbles external channel plugin** for Orchid.
...
- Route into core reply pipeline via the plugin runtime (`api.runtime`) and `orchid/plugin-sdk` helpers.
