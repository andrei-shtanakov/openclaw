...
import { resolveChannelMediaMaxBytes, type OrchidConfig } from "orchid/plugin-sdk";
...
function resolveMediaLocalRoots(params: { cfg: OrchidConfig; accountId?: string }): string[] {
