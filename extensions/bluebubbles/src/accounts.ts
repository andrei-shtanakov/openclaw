...
export function listBlueBubblesAccountIds(cfg: OrchidConfig): string[] {
...
export function resolveDefaultBlueBubblesAccountId(cfg: OrchidConfig): string {
...
export function listEnabledBlueBubblesAccounts(cfg: OrchidConfig): ResolvedBlueBubblesAccount[] {
