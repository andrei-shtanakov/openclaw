...
export function listMattermostAccountIds(cfg: OrchidConfig): string[] {
...
export function resolveDefaultMattermostAccountId(cfg: OrchidConfig): string {
...
export function listEnabledMattermostAccounts(cfg: OrchidConfig): ResolvedMattermostAccount[] {
