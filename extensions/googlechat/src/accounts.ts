...
export function listGoogleChatAccountIds(cfg: OrchidConfig): string[] {
...
export function resolveDefaultGoogleChatAccountId(cfg: OrchidConfig): string {
...
export function listEnabledGoogleChatAccounts(cfg: OrchidConfig): ResolvedGoogleChatAccount[] {
