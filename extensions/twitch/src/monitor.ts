...
import type { ReplyPayload, OrchidConfig } from "orchid/plugin-sdk";
import { createReplyPrefixOptions } from "orchid/plugin-sdk";
...
async function processTwitchMessage(params: {
  ...
  const cfg = config as OrchidConfig;
