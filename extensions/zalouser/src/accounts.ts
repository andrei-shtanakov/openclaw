...
export function listZalouserAccountIds(cfg: OrchidConfig): string[] {
...
export function resolveDefaultZalouserAccountId(cfg: OrchidConfig): string {
...
function mergeZalouserAccountConfig(cfg: OrchidConfig, accountId: string): ZalouserAccountConfig {
