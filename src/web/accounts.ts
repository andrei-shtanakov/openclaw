...
export function listWhatsAppAuthDirs(cfg: OrchidConfig): string[] {
...
export function hasAnyWhatsAppAuth(cfg: OrchidConfig): boolean {
...
export function resolveWhatsAppAuthDir(params: { cfg: OrchidConfig; accountId: string }): {
  authDir: string;
  isLegacy: boolean;
} {
...
export function listEnabledWhatsAppAccounts(cfg: OrchidConfig): ResolvedWhatsAppAccount[] {
