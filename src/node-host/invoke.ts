...
const execHostEnforced = process.env.ORCHID_NODE_EXEC_HOST?.trim().toLowerCase() === "app";
const execHostFallbackAllowed = process.env.ORCHID_NODE_EXEC_FALLBACK?.trim().toLowerCase() !== "0";
