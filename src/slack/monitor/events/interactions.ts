...
// Prefix for Orchid-generated action IDs to scope our handler
const ORCHID_ACTION_PREFIX = "orchid:";
...
export function registerSlackInteractionEvents(params: { ctx: SlackMonitorContext }) {
  ...
  const modalMatcher = new RegExp(`^${ORCHID_ACTION_PREFIX}`);

  // Handle Orchid modal submissions with callback_ids scoped by our prefix.
