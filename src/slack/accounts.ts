...
function mergeSlackAccountConfig(cfg: OrchidConfig, accountId: string): SlackAccountConfig {
...
export function listEnabledSlackAccounts(cfg: OrchidConfig): ResolvedSlackAccount[] {
