...
function resolveMentionPatterns(cfg: OrchidConfig | undefined, agentId?: string): string[] {
  if (!cfg) {
    return [];
  }
...
export function buildMentionRegexes(cfg: OrchidConfig | undefined, agentId?: string): RegExp[] {
