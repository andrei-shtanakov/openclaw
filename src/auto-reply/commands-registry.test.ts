...
describe("commands registry", () => {
  ...
  it("normalizes telegram-style command mentions for the current bot", () => {
    expect(normalizeCommandBody("/help@orchid", { botUsername: "orchid" })).toBe("/help");
    expect(
      normalizeCommandBody("/help@orchid args", {
        botUsername: "orchid",
      }),
    ).toBe("/help args");
    expect(
  ...
  it("keeps telegram-style command mentions for other bots", () => {
    expect(normalizeCommandBody("/help@otherbot", { botUsername: "orchid" })).toBe(
      "/help@otherbot",
    );
  });
