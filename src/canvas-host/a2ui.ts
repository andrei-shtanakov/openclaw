...
export const A2UI_PATH = "/__orchid__/a2ui";

export const CANVAS_HOST_PATH = "/__orchid__/canvas";

export const CANVAS_WS_PATH = "/__orchid__/ws";
...
(() => {
  ...
  // Works on:
  // - iOS: window.webkit.messageHandlers.orchidCanvasA2UIAction.postMessage(...)
  // - Android: window.orchidCanvasA2UIAction.postMessage(...)
  const handlerNames = ["orchidCanvasA2UIAction"];
  ...
  globalThis.Orchid = globalThis.Orchid ?? {};
  globalThis.Orchid.postMessage = postToNode;
  globalThis.Orchid.sendUserAction = sendUserAction;
  globalThis.orchidPostMessage = postToNode;
  globalThis.orchidSendUserAction = sendUserAction;
