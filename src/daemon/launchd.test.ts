...
describe("launchctl list detection", () => {
  it("detects the resolved label in launchctl list", async () => {
    state.listOutput = "123 0 ai.orchid.gateway\n";
    const listed = await isLaunchAgentListed({
      env: { HOME: "/Users/test", ORCHID_PROFILE: "default" },
    });
...
describe("launchd install", () => {
  ...
  it("shows actionable guidance when launchctl gui domain does not support bootstrap", async () => {
    ...
    expect(message).toContain("https://docs.orchid.ai/gateway");
  });
...
describe("resolveLaunchAgentPlistPath", () => {
  it.each([
    {
      name: "uses default label when ORCHID_PROFILE is unset",
      env: { HOME: "/Users/test" },
      expected: "/Users/test/Library/LaunchAgents/ai.orchid.gateway.plist",
    },
    {
      name: "uses profile-specific label when ORCHID_PROFILE is set to a custom value",
      env: { HOME: "/Users/test", ORCHID_PROFILE: "jbphoenix" },
      expected: "/Users/test/Library/LaunchAgents/ai.orchid.jbphoenix.plist",
    },
    {
      name: "prefers ORCHID_LAUNCHD_LABEL over ORCHID_PROFILE",
      env: {
        HOME: "/Users/test",
        ORCHID_PROFILE: "jbphoenix",
        ORCHID_LAUNCHD_LABEL: "com.custom.label",
      },
      expected: "/Users/test/Library/LaunchAgents/com.custom.label.plist",
    },
    {
      name: "trims whitespace from ORCHID_LAUNCHD_LABEL",
      env: {
        HOME: "/Users/test",
        ORCHID_LAUNCHD_LABEL: "  com.custom.label  ",
      },
    ...
    {
      name: "ignores empty ORCHID_LAUNCHD_LABEL and falls back to profile",
      env: {
        HOME: "/Users/test",
        ORCHID_PROFILE: "myprofile",
        ORCHID_LAUNCHD_LABEL: "   ",
      },
      expected: "/Users/test/Library/LaunchAgents/ai.orchid.myprofile.plist",
    },
  ])("$name", ({ env, expected }) => {
