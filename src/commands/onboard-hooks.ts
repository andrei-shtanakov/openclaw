...
export async function setupInternalHooks(
  ...
  await prompter.note(
    [
      ...
      "",
      "Learn more: https://docs.orchid.ai/automation/hooks",
    ].join("\n"),
    "Hooks",
  );
  ...
  await prompter.note(
    [
      ...
      `  ${formatCliCommand("orchid hooks list")}`,
      `  ${formatCliCommand("orchid hooks enable <name>")}`,
      `  ${formatCliCommand("orchid hooks disable <name>")}`,
    ].join("\n"),
    "Hooks Configured",
  );
