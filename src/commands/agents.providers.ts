...
function resolveDefaultAccountId(cfg: OrchidConfig, provider: ChannelId): string {
...
function shouldShowProviderEntry(entry: ProviderAccountStatus, cfg: OrchidConfig): boolean {
...
export function summarizeBindings(cfg: OrchidConfig, bindings: AgentBinding[]): string[] {
