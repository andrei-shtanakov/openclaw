...
type PromptDefaultModelResult = { model?: string; config?: OrchidConfig };
...
function resolveConfiguredModelRaw(cfg: OrchidConfig): string {
...
function resolveConfiguredModelKeys(cfg: OrchidConfig): string[] {
...
export function applyPrimaryModel(cfg: OrchidConfig, model: string): OrchidConfig {
...
export function applyModelAllowlist(cfg: OrchidConfig, models: string[]): OrchidConfig {
  const defaults = cfg.agents?.defaults;
