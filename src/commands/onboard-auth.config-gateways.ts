...
export function applyVercelAiGatewayProviderConfig(cfg: OrchidConfig): OrchidConfig {
...
export function applyVercelAiGatewayConfig(cfg: OrchidConfig): OrchidConfig {
