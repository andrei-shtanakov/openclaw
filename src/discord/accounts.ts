...
function mergeDiscordAccountConfig(cfg: OrchidConfig, accountId: string): DiscordAccountConfig {
...
export function listEnabledDiscordAccounts(cfg: OrchidConfig): ResolvedDiscordAccount[] {
