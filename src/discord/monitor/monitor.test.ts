...
describe("agent components", () => {
  const createCfg = (): OrchidConfig => ({}) as OrchidConfig;
...
describe("discord component interactions", () => {
  ...
  beforeEach(() => {
    ...
    resolveStorePathMock.mockClear().mockReturnValue("/tmp/orchid-sessions-test.json");
  });
