...
describe("QmdMemoryManager", () => {
  ...
  let stateDir: string;
  let cfg: OrchidConfig;
  const agentId = "main";

  async function createManager(params?: { mode?: "full" | "status"; cfg?: OrchidConfig }) {
  ...
  afterEach(async () => {
    ...
    delete (globalThis as Record<string, unknown>).__orchidMcporterDaemonStart;
    delete (globalThis as Record<string, unknown>).__orchidMcporterColdStartWarned;
  });
