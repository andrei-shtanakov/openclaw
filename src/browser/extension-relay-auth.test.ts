...
describe("extension-relay-auth", () => {
  ...
  it("accepts authenticated orchid relay probe responses", async () => {
    ...
    await withRelayServer(
      ...
      async ({ port }) => {
        ...
        const ok = await probeAuthenticatedOrchidRelay({
          baseUrl: `http://127.0.0.1:${port}`,
          relayAuthHeader: "x-orchid-relay-token",
