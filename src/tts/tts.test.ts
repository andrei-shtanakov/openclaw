...
describe("tts", () => {
  ...
  describe("maybeApplyTtsToPayload", () => {
    ...
    const withMockedAutoTtsFetch = async (
      ...
      const prevPrefs = process.env.ORCHID_TTS_PREFS;
      process.env.ORCHID_TTS_PREFS = `/tmp/tts-test-${Date.now()}.json`;
      ...
      try {
        ...
        process.env.ORCHID_TTS_PREFS = prevPrefs;
      }
    };

    const taggedCfg: OrchidConfig = {
      ...baseCfg,
      messages: {
        ...baseCfg.messages!,
