...
describe("daemon-cli coverage", () => {
  ...
  beforeEach(() => {
    ...
    process.env.ORCHID_STATE_DIR = "/tmp/orchid-cli-state";
    process.env.ORCHID_CONFIG_PATH = "/tmp/orchid-cli-state/orchid.json";
    delete process.env.ORCHID_GATEWAY_PORT;
    delete process.env.ORCHID_PROFILE;
  ...
  it("derives probe URL from service args + env (json)", async () => {
    ...
    serviceReadCommand.mockResolvedValueOnce({
      ...
      environment: {
        ORCHID_PROFILE: "dev",
        ORCHID_STATE_DIR: "/tmp/orchid-daemon-state",
        ORCHID_CONFIG_PATH: "/tmp/orchid-daemon-state/orchid.json",
        ORCHID_GATEWAY_PORT: "19001",
      },
