...
const SANDBOX_EXAMPLES = {
  main: [
    ["orchid sandbox list", "List all sandbox containers."],
    ["orchid sandbox list --browser", "List only browser containers."],
    ["orchid sandbox recreate --all", "Recreate all containers."],
    ["orchid sandbox recreate --session main", "Recreate a specific session."],
    ["orchid sandbox recreate --agent mybot", "Recreate agent containers."],
    ["orchid sandbox explain", "Explain effective sandbox config."],
  ],
  list: [
    ["orchid sandbox list", "List all sandbox containers."],
    ["orchid sandbox list --browser", "List only browser containers."],
  ...
  recreate: [
    ["orchid sandbox recreate --all", "Recreate all containers."],
    ["orchid sandbox recreate --session main", "Recreate a specific session."],
    ["orchid sandbox recreate --agent mybot", "Recreate a specific agent (includes sub-agents)."],
    ["orchid sandbox recreate --browser --all", "Recreate only browser containers."],
    ["orchid sandbox recreate --all --force", "Skip confirmation."],
  ],
  explain: [
    ["orchid sandbox explain", "Show effective sandbox config."],
    ["orchid sandbox explain --session agent:main:main", "Explain a specific session."],
    ["orchid sandbox explain --agent work", "Explain an agent sandbox."],
    ["orchid sandbox explain --json", "JSON output."],
  ],
} as const;
...
export function registerSandboxCli(program: Command) {
  const sandbox = program
    ...
    .addHelpText(
      "after",
      () =>
        `\n${theme.muted("Docs:")} ${formatDocsLink("/cli/sandbox", "docs.orchid.ai/cli/sandbox")}\n`,
    )
    .action(() => {
