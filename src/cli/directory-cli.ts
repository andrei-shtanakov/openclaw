    ...
    .addHelpText(
      ...
      () =>
        `\n${theme.heading("Examples:")}\n${formatHelpExamples([
          ["orchid directory self --channel slack", "Show the connected account identity."],
          [
            'orchid directory peers list --channel slack --query "alice"',
            "Search contact/user IDs by name.",
          ],
          ["orchid directory groups list --channel discord", "List available groups/channels."],
          [
            "orchid directory groups members --channel discord --group-id <id>",
            "List members for a specific group.",
          ],
        ])}\n\n${theme.muted("Docs:")} ${formatDocsLink(
          "/cli/directory",
          "docs.orchid.ai/cli/directory",
        )}\n`,
    )
    .action(() => {
