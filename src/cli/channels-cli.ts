    ...
    .addHelpText(
      ...
      () =>
        `\n${theme.heading("Examples:")}\n${formatHelpExamples([
          ["orchid channels list", "List configured channels and auth profiles."],
          ["orchid channels status --probe", "Run channel status checks and probes."],
          [
            "orchid channels add --channel telegram --token <token>",
            "Add or update a channel account non-interactively.",
          ],
          ["orchid channels login --channel whatsapp", "Link a WhatsApp Web account."],
        ])}\n\n${theme.muted("Docs:")} ${formatDocsLink(
          "/cli/channels",
          "docs.orchid.ai/cli/channels",
        )}\n`,
    );
