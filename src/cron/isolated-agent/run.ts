...
export type RunCronAgentTurnResult = {
   ...
   * messages.  See: https://github.com/orchid/orchid/issues/15692
   */
  delivered?: boolean;
} & CronRunOutcome &
  CronRunTelemetry;
...
export async function runCronIsolatedAgentTurn(params: {
  ...
  const isFastTestEnv = process.env.ORCHID_TEST_FAST === "1";
  ...
  // correct per-agent paths (e.g. ~/.orchid/agents/<agentId>/agent/).
  ...
  const cfgWithAgentDefaults: OrchidConfig = {
    ...params.cfg,
