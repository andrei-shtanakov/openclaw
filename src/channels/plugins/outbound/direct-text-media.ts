...
export function resolveScopedChannelMediaMaxBytes(params: {
  cfg: OrchidConfig;
  accountId?: string | null;
  resolveChannelLimitMb: (params: { cfg: OrchidConfig; accountId: string }) => number | undefined;
}): number | undefined {
...
export function createScopedChannelMediaMaxBytesResolver(channel: "imessage" | "signal") {
  return (params: { cfg: OrchidConfig; accountId?: string | null }) =>
...
>(params: {
  ...
  resolveMaxBytes: (params: { cfg: OrchidConfig; accountId?: string | null }) => number | undefined;
