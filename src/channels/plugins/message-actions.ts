...
export function listChannelMessageActions(cfg: OrchidConfig): ChannelMessageActionName[] {
...
export function supportsChannelMessageButtons(cfg: OrchidConfig): boolean {
...
export function supportsChannelMessageCards(cfg: OrchidConfig): boolean {
