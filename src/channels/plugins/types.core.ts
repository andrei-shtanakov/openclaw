...
export type ChannelAgentToolFactory = (params: { cfg?: OrchidConfig }) => ChannelAgentTool[];
...
export type ChannelAgentPromptAdapter = {
  messageToolHints?: (params: { cfg: OrchidConfig; accountId?: string | null }) => string[];
};
...
export type ChannelMessageActionAdapter = {
  listActions?: (params: { cfg: OrchidConfig }) => ChannelMessageActionName[];
  supportsAction?: (params: { action: ChannelMessageActionName }) => boolean;
  supportsButtons?: (params: { cfg: OrchidConfig }) => boolean;
  supportsCards?: (params: { cfg: OrchidConfig }) => boolean;
