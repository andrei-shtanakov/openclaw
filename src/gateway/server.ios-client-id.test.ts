...
beforeAll(async () => {
  previousToken = process.env.ORCHID_GATEWAY_TOKEN;
  process.env.ORCHID_GATEWAY_TOKEN = "test-gateway-token-1234567890";
...
afterAll(async () => {
  ...
  if (previousToken === undefined) {
    ...
    process.env.ORCHID_GATEWAY_TOKEN = previousToken;
  }
});
...
test.each([
  { clientId: "orchid-ios", platform: "ios" },
  { clientId: "orchid-android", platform: "android" },
