...
import { type OrchidConfig, loadConfig } from "../config/config.js";
...
function listConfiguredAgentIds(cfg: OrchidConfig): string[] {
...
export function listAgentsForGateway(cfg: OrchidConfig): {
  defaultId: string;
  mainKey: string;
  scope: SessionScope;
...
function resolveDefaultStoreAgentId(cfg: OrchidConfig): string {
  return normalizeAgentId(resolveDefaultAgentId(cfg));
}

export function resolveSessionStoreKey(params: { cfg: OrchidConfig; sessionKey: string }): string {
...
function resolveSessionStoreAgentId(cfg: OrchidConfig, canonicalKey: string): string {
...
export function loadCombinedSessionStoreForGateway(cfg: OrchidConfig): {
  storePath: string;
  store: Record<string, SessionEntry>;
} {
...
export function getSessionDefaults(cfg: OrchidConfig): GatewaySessionsDefaults {
