...
export function listBindings(cfg: OrchidConfig): AgentBinding[] {
...
export function listBoundAccountIds(cfg: OrchidConfig, channelId: string): string[] {
...
export function buildChannelAccountBindings(cfg: OrchidConfig) {
