...
export type { OrchidConfig } from "../config/config.js";
/** @deprecated Use OrchidConfig instead */
export type { OrchidConfig as ClawdbotConfig } from "../config/config.js";
