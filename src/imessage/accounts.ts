...
function mergeIMessageAccountConfig(cfg: OrchidConfig, accountId: string): IMessageAccountConfig {
...
export function listEnabledIMessageAccounts(cfg: OrchidConfig): ResolvedIMessageAccount[] {
