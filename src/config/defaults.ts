...
function resolveAnthropicDefaultAuthMode(cfg: OrchidConfig): AnthropicAuthDefaultsMode | null {
...
export function applyMessageDefaults(cfg: OrchidConfig): OrchidConfig {
...
export function applyTalkApiKey(config: OrchidConfig): OrchidConfig {
...
export function applyModelDefaults(cfg: OrchidConfig): OrchidConfig {
  let mutated = false;
  let nextCfg = cfg;
...
export function applyAgentDefaults(cfg: OrchidConfig): OrchidConfig {
...
export function applyLoggingDefaults(cfg: OrchidConfig): OrchidConfig {
...
export function applyContextPruningDefaults(cfg: OrchidConfig): OrchidConfig {
...
export function applyCompactionDefaults(cfg: OrchidConfig): OrchidConfig {
  const defaults = cfg.agents?.defaults;
  if (!defaults) {
    return cfg;
  }
