...
function isTelegramConfigured(cfg: OrchidConfig, env: NodeJS.ProcessEnv): boolean {
...
function isDiscordConfigured(cfg: OrchidConfig, env: NodeJS.ProcessEnv): boolean {
...
function isIrcConfigured(cfg: OrchidConfig, env: NodeJS.ProcessEnv): boolean {
...
function isSlackConfigured(cfg: OrchidConfig, env: NodeJS.ProcessEnv): boolean {
  if (
...
function isSignalConfigured(cfg: OrchidConfig): boolean {
...
function isIMessageConfigured(cfg: OrchidConfig): boolean {
...
function isWhatsAppConfigured(cfg: OrchidConfig): boolean {
...
function isGenericChannelConfigured(cfg: OrchidConfig, channelId: string): boolean {
...
function collectModelRefs(cfg: OrchidConfig): string[] {
  const refs: string[] = [];
...
function isProviderConfigured(cfg: OrchidConfig, providerId: string): boolean {
...
function resolveConfiguredPlugins(cfg: OrchidConfig, env: NodeJS.ProcessEnv): PluginEnableChange[] {
...
function isPluginExplicitlyDisabled(cfg: OrchidConfig, pluginId: string): boolean {
  const entry = cfg.plugins?.entries?.[pluginId];
  return entry?.enabled === false;
}

function isPluginDenied(cfg: OrchidConfig, pluginId: string): boolean {
...
function registerPluginEntry(cfg: OrchidConfig, pluginId: string): OrchidConfig {
  const entries = {
    ...cfg.plugins?.entries,
    [pluginId]: {
