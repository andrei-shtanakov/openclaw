...
import type { OrchidConfig, ReplyToMode, TelegramAccountConfig } from "../config/types.js";
...
async function resolveStickerVisionSupport(cfg: OrchidConfig, agentId: string) {
  try {
