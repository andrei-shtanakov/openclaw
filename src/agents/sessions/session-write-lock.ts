...
const CLEANUP_STATE_KEY = Symbol.for("orchid.sessionWriteLockCleanupState");
const HELD_LOCKS_KEY = Symbol.for("orchid.sessionWriteLockHeldLocks");
const WATCHDOG_STATE_KEY = Symbol.for("orchid.sessionWriteLockWatchdogState");
