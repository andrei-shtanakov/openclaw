...
function makeCfg(overrides: Partial<OrchidConfig> = {}): OrchidConfig {
  return {
    agents: {
      defaults: {
        model: {
...
function makeFallbacksOnlyCfg(): OrchidConfig {
  return {
    agents: {
      defaults: {
        model: {
...
function makeProviderFallbackCfg(provider: string): OrchidConfig {
  return makeCfg({
    agents: {
      defaults: {
        model: {
