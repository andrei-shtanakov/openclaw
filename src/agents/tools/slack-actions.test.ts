...
describe("handleSlackAction", () => {
  function slackConfig(overrides?: Record<string, unknown>): OrchidConfig {
    return {
      channels: {
        slack: {
          botToken: "tok",
  ...
  async function resolveReadToken(cfg: OrchidConfig): Promise<string | undefined> {
  ...
  async function resolveSendToken(cfg: OrchidConfig): Promise<string | undefined> {
