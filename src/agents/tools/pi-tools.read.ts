...
function resolveAdaptiveReadMaxBytes(options?: OrchidReadToolOptions): number {
...
export function createSandboxedReadTool(params: SandboxToolParams) {
  ...
  return createOrchidReadTool(base, {
...
export function createOrchidReadTool(
  base: AnyAgentTool,
  options?: OrchidReadToolOptions,
): AnyAgentTool {
