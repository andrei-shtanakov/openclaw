...
function resolveMemoryToolContext(options: { config?: OrchidConfig; agentSessionKey?: string }) {
...
function resolveMemoryCitationsMode(cfg: OrchidConfig): MemoryCitationsMode {
