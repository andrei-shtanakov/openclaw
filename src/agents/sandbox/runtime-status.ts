...
function resolveMainSessionKeyForSandbox(params: { cfg?: OrchidConfig; agentId: string }): string {
...
export function resolveSandboxRuntimeStatus(params: { cfg?: OrchidConfig; sessionKey?: string }): {
  agentId: string;
  sessionKey: string;
...
export function formatSandboxToolPolicyBlockedMessage(params: {
  ...
  lines.push(
    `- See: ${formatCliCommand(`orchid sandbox explain --session ${runtime.sessionKey}`)}`,
  );
