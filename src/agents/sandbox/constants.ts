...
export const DEFAULT_SANDBOX_IMAGE = "orchid-sandbox:bookworm-slim";
export const DEFAULT_SANDBOX_CONTAINER_PREFIX = "orchid-sbx-";
...
export const DEFAULT_SANDBOX_BROWSER_IMAGE = "orchid-sandbox-browser:bookworm-slim";
export const DEFAULT_SANDBOX_COMMON_IMAGE = "orchid-sandbox-common:bookworm-slim";
export const SANDBOX_BROWSER_SECURITY_HASH_EPOCH = "2026-02-21-novnc-auth-default";

export const DEFAULT_SANDBOX_BROWSER_PREFIX = "orchid-sbx-browser-";
export const DEFAULT_SANDBOX_BROWSER_NETWORK = "orchid-sandbox-browser";
