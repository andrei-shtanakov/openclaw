...
describe("buildSandboxCreateArgs", () => {
  ...
  it("includes hardening and resource flags", () => {
    ...
    const args = buildSandboxCreateArgs({
      name: "orchid-sbx-test",
      cfg,
      scopeKey: "main",
      createdAtMs: 1700000000000,
      labels: { "orchid.sandboxBrowser": "1" },
    });
    ...
    expect(args).toEqual(
      expect.arrayContaining([
        ...
        "orchid.sandbox=1",
        "--label",
        "orchid.sessionKey=main",
        "--label",
        "orchid.createdAtMs=1700000000000",
        "--label",
