...
function resolveAvatarSource(cfg: OrchidConfig, agentId: string): string | null {
...
export function resolveAgentAvatar(cfg: OrchidConfig, agentId: string): AgentAvatarResolution {
