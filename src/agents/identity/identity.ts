import type { OrchidConfig, HumanDelayConfig, IdentityConfig } from "../../config/config.js";
...
export function resolveIdentityNamePrefix(cfg: OrchidConfig, agentId: string): string | undefined {
...
export function resolveIdentityName(cfg: OrchidConfig, agentId: string): string | undefined {
...
export function resolveMessagePrefix(
  ...
  return resolveIdentityNamePrefix(cfg, agentId) ?? opts?.fallback ?? "[orchid]";
}

/** Helper to extract a channel config value by dynamic key. */
function getChannelConfig(cfg: OrchidConfig, channel: string): Record<string, unknown> | undefined {
