...
function resolveWatchPaths(workspaceDir: string, config?: OrchidConfig): string[] {
  const paths: string[] = [];
...
function resolveWatchTargets(workspaceDir: string, config?: OrchidConfig): string[] {
...
export function ensureSkillsWatcher(params: { workspaceDir: string; config?: OrchidConfig }) {
