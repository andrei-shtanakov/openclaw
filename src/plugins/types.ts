...
export type OrchidPluginConfigSchema = {
...
export type OrchidPluginToolContext = {
  config?: OrchidConfig;
  workspaceDir?: string;
  agentDir?: string;
  agentId?: string;
...
export type OrchidPluginToolFactory = (
  ctx: OrchidPluginToolContext,
) => AnyAgentTool | AnyAgentTool[] | null | undefined;

export type OrchidPluginToolOptions = {
  name?: string;
  names?: string[];
  optional?: boolean;
};

export type OrchidPluginHookOptions = {
  entry?: HookEntry;
  name?: string;
  description?: string;
  register?: boolean;
...
export type ProviderAuthResult = {
  ...
  configPatch?: Partial<OrchidConfig>;
  defaultModel?: string;
  notes?: string[];
};
...
export type OrchidPluginGatewayMethod = {
  method: string;
 ...
 */
export type OrchidPluginCommandDefinition = {
...
export type OrchidPluginHttpHandler = (
  req: IncomingMessage,
  res: ServerResponse,
) => Promise<boolean> | boolean;

export type OrchidPluginHttpRouteHandler = (
  req: IncomingMessage,
  res: ServerResponse,
) => Promise<void> | void;

export type OrchidPluginCliContext = {
  program: Command;
  config: OrchidConfig;
  workspaceDir?: string;
  logger: PluginLogger;
...
export type OrchidPluginCliRegistrar = (ctx: OrchidPluginCliContext) => void | Promise<void>;

export type OrchidPluginServiceContext = {
  config: OrchidConfig;
  workspaceDir?: string;
  stateDir: string;
  logger: PluginLogger;
...
export type OrchidPluginService = {
  id: string;
  start: (ctx: OrchidPluginServiceContext) => void | Promise<void>;
  stop?: (ctx: OrchidPluginServiceContext) => void | Promise<void>;
};

export type OrchidPluginChannelRegistration = {
  plugin: ChannelPlugin;
  dock?: ChannelDock;
};

export type OrchidPluginDefinition = {
  id?: string;
  name?: string;
  description?: string;
  version?: string;
  kind?: PluginKind;
  configSchema?: OrchidPluginConfigSchema;
  register?: (api: OrchidPluginApi) => void | Promise<void>;
  activate?: (api: OrchidPluginApi) => void | Promise<void>;
};

export type OrchidPluginModule =
  | OrchidPluginDefinition
  | ((api: OrchidPluginApi) => void | Promise<void>);

export type OrchidPluginApi = {
  id: string;
  name: string;
  version?: string;
  description?: string;
  ...
  logger: PluginLogger;
  registerTool: (
    tool: AnyAgentTool | OrchidPluginToolFactory,
    opts?: OrchidPluginToolOptions,
  ) => void;
  registerHook: (
    events: string | string[],
    handler: InternalHookHandler,
    opts?: OrchidPluginHookOptions,
  ) => void;
  registerHttpHandler: (handler: OrchidPluginHttpHandler) => void;
  registerHttpRoute: (params: { path: string; handler: OrchidPluginHttpRouteHandler }) => void;
  registerChannel: (registration: OrchidPluginChannelRegistration | ChannelPlugin) => void;
  registerGatewayMethod: (method: string, handler: GatewayRequestHandler) => void;
  registerCli: (registrar: OrchidPluginCliRegistrar, opts?: { commands?: string[] }) => void;
  registerService: (service: OrchidPluginService) => void;
   ...
   */
  registerCommand: (command: OrchidPluginCommandDefinition) => void;
