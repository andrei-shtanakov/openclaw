...
function deriveIdHint(params: {
  ...
  // package is scoped (example: @orchid/voice-call -> voice-call).
...
export function discoverOrchidPlugins(params: {
  workspaceDir?: string;
  extraPaths?: string[];
  ownershipUid?: number | null;
  ...
  if (workspaceDir) {
    ...
    const workspaceExtDirs = [path.join(workspaceRoot, ".orchid", "extensions")];
