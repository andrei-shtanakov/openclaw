...
describe("formatPluginSourceForTable", () => {
  it("shortens bundled plugin sources under the stock root", () => {
    const out = formatPluginSourceForTable(
      {
        origin: "bundled",
        source: "/opt/homebrew/lib/node_modules/orchid/extensions/bluebubbles/index.ts",
      },
      {
        stock: "/opt/homebrew/lib/node_modules/orchid/extensions",
        global: "/Users/x/.orchid/extensions",
        workspace: "/Users/x/ws/.orchid/extensions",
      },
    );
  ...
  it("shortens workspace plugin sources under the workspace root", () => {
    const out = formatPluginSourceForTable(
      {
        origin: "workspace",
        source: "/Users/x/ws/.orchid/extensions/matrix/index.ts",
      },
      {
        stock: "/opt/homebrew/lib/node_modules/orchid/extensions",
        global: "/Users/x/.orchid/extensions",
  ...
  it("shortens global plugin sources under the global root", () => {
    const out = formatPluginSourceForTable(
      {
        origin: "global",
        source: "/Users/x/.orchid/extensions/zalo/index.js",
      },
      {
        stock: "/opt/homebrew/lib/node_modules/orchid/extensions",
        global: "/Users/x/.orchid/extensions",
