...
function setGroupPolicyAllowlist(params: {
  ...
  const section = params.cfg.channels[params.channel as keyof OrchidConfig["channels"]] as
...
function applyConfigFixes(params: { cfg: OrchidConfig; env: NodeJS.ProcessEnv }): {
  cfg: OrchidConfig;
  changes: string[];
  policyFlips: Set<string>;
} {
