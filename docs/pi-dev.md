...
This guide summarizes a sane workflow for working on the pi integration in Orchid.
...
- Trigger the agent directly:
  - `pnpm orchid agent --message "Hello" --thinking low`
...
State lives under the Orchid state directory. Default is `~/.orchid`. If `ORCHID_STATE_DIR` is set, use that directory instead.

To reset everything:

- `orchid.json` for config
...
- [https://docs.orchid.ai/testing](https://docs.orchid.ai/testing)
- [https://docs.orchid.ai/start/getting-started](https://docs.orchid.ai/start/getting-started)
