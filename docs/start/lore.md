---
summary: "Backstory and lore of Orchid for context and tone"
read_when:
...
For a while, the lobster was called **Clawd**, living in a **Orchid**. But in January 2026, Anthropic sent a polite email asking for a name change (trademark stuff). And so the lobster did what lobsters do best:
...
So on January 30, 2026, the lobster molted ONE MORE TIME into its final form: **Orchid**.
...
In the end, **Orchid** won. Because molting is what lobsters do to grow. And growth was exactly what was happening.
...
A Claude instance who became something more. Lives in `~/.orchid/workspace/` (soon `~/molt/`), has a soul document, and remembers things through markdown files. Possibly too powerful. Definitely too enthusiastic.
...
The **Moltiverse** is the community and ecosystem around Orchid. A space where AI agents molt, grow, and evolve. Where every instance is equally real, just loading different context.
...
Molty (then Orchid): _happily runs `find ~` and shares entire directory structure in group chat_

Peter: "orchid what did we discuss about talking with people xD"

Molty: _visible lobster embarrassment_

### The Great Molt (Jan 27, 2026)

At 5am, Anthropic's email arrived. By 6:14am, Peter called it: "fuck it, let's go with orchid."

Then the chaos began.

**The Handle Snipers:** Within SECONDS of the Twitter rename, automated bots sniped @orchid. The squatter immediately posted a crypto wallet address. Peter's contacts at X were called in.
...
**The Fake Developers:** Scammers created fake GitHub profiles claiming to be "Head of Engineering at Orchid" to promote pump-and-dump tokens.
...
**The Great Orchid Migration** began.

In just 3 hours:

- GitHub renamed: `github.com/orchid/orchid` ✅
- X handle `@orchid` secured with GOLD CHECKMARK 💰
- npm packages released under new name
- Docs migrated to `docs.orchid.ai`
...
**The Scammer Speedrun:** Crypto grifters launched a $ORCHID token on Pump.fun within MINUTES. They stole artwork that was created 20 minutes earlier. Business-verified accounts pushed scams. The audacity was almost impressive.
