---
summary: "Overview of Orchid onboarding options and flows"
read_when:
...
Orchid supports multiple onboarding paths depending on where the Gateway runs
...
- [`orchid onboard` command](/cli/onboard)

## macOS app onboarding

Use the Orchid app when you want a fully guided setup on macOS. Docs:
