---
summary: "First-run onboarding flow for Orchid (macOS app)"
read_when:
...
<Frame caption="Choose what permissions do you want to give Orchid">
...
<Step title="CLI">
  ...
  The app can install the global `orchid` CLI via npm/pnpm so terminal
