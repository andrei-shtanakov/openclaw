...
```
  ...
  <Tab title="HTTP Events API mode">
    <Steps>
      ...
      <Step title="Configure Orchid HTTP mode">
...
<Tabs>
  <Tab title="DM policy">
    ...
    Pairing in DMs uses `orchid pairing approve slack <code>`.
...
Orchid supports Slack native text streaming via the Agents and AI Apps API.
...
- If streaming fails mid-reply, Orchid falls back to normal delivery for remaining payloads.
