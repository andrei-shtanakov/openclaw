...
- Install via CLI: `orchid plugins install @orchid/zalo`
...
1. Install the Zalo plugin:
   - From a source checkout: `orchid plugins install ./extensions/zalo`
   - From npm (if published): `orchid plugins install @orchid/zalo`
...
- Approve via:
  - `orchid pairing list zalo`
  - `orchid pairing approve zalo <CODE>`
...
- Example: `orchid message send --channel zalo --target 123456789 --message "hi"`.

## Troubleshooting

**Bot doesn't respond:**

- Check that the token is valid: `orchid channels status --probe`
- Verify the sender is approved (pairing or allowFrom)
- Check gateway logs: `orchid logs --follow`
