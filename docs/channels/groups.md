...
Orchid treats group chats consistently across surfaces: WhatsApp, Telegram, Discord, Slack, Signal, iMessage, Microsoft Teams.

## Beginner intro (2 minutes)

Orchid “lives” on your own messaging accounts. There is no separate WhatsApp bot user.
If **you** are in a group, Orchid can see that group and respond there.
...
Translation: allowlisted senders can trigger Orchid by mentioning it.
    ...
    list: [
      {
        id: "main",
        groupChat: {
          mentionPatterns: ["@orchid", "orchid", "\\+15555550123"],
          historyLimit: 50,
        },
      },
    ],
