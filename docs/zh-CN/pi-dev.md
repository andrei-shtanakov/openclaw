...
本指南总结了在 Orchid 中开发 Pi 集成的合理工作流程。
...
状态存储在 Orchid 状态目录下。默认为 `~/.orchid`。如果设置了 `ORCHID_STATE_DIR`，则使用该目录。
...
- https://docs.orchid.ai/testing
- https://docs.orchid.ai/start/getting-started
