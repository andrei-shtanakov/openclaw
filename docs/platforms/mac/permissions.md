...
- Same path: run the app from a fixed location (for Orchid, `dist/Orchid.app`).
...
Workaround: move files into the Orchid workspace (`~/.orchid/workspace`) if you want to avoid per-folder grants.
