...
read_when:
  - You are building a Orchid plugin
  - You need to ship a plugin config schema or debug plugin validation errors
title: "Plugin Manifest"
---

# Plugin manifest (orchid.plugin.json)

Every plugin **must** ship a `orchid.plugin.json` file in the **plugin root**.
Orchid uses this manifest to validate configuration **without executing plugin
