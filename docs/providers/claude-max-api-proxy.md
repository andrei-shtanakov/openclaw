...
You can point Orchid at the proxy as a custom OpenAI-compatible endpoint:
...
- This is a **community tool**, not officially supported by Anthropic or Orchid
...
- [Anthropic provider](/providers/anthropic) - Native Orchid integration with Claude setup-token or API keys
