---
summary: "Use Qianfan's unified API to access many models in Orchid"
read_when:
...
3. Orchid installed on your system
...
4. Copy the API key for use with Orchid

## CLI setup

```bash
orchid onboard --auth-choice qianfan-api-key
```

## Related Documentation

- [Orchid Configuration](/gateway/configuration)
