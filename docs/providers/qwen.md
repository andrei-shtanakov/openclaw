---
summary: "Use Qwen OAuth (free tier) in Orchid"
read_when:
  - You want to use Qwen with Orchid
...
If you already logged in with the Qwen Code CLI, Orchid will sync credentials
