---
summary: "Use Xiaomi MiMo (mimo-v2-flash) with Orchid"
read_when:
  - You want Xiaomi MiMo models in Orchid
...
the [Xiaomi MiMo console](https://platform.xiaomimimo.com/#/console/api-keys). Orchid uses
