---
summary: "Use NVIDIA's OpenAI-compatible API in Orchid"
read_when:
  - You want to use NVIDIA models in Orchid
...
orchid onboard --auth-choice skip
orchid models set nvidia/nvidia/llama-3.1-nemotron-70b-instruct
```
