---
summary: "Frequently asked questions about Orchid setup, configuration, and usage"
title: "FAQ"
---
...
- [Quick start and first-run setup]
  ...
  - [What's the recommended way to install and set up Orchid?](#whats-the-recommended-way-to-install-and-set-up-orchid)
  ...
  - [I can't access docs.orchid.ai (SSL error). What now?](#i-cant-access-docsorchidai-ssl-error-what-now)
  - [What's the difference between stable and beta?](#whats-the-difference-between-stable-and-beta)
  - [How do I install the beta version, and what's the difference between beta and dev?](#how-do-i-install-the-beta-version-and-whats-the-difference-between-beta-and-dev)
  - [How do I try the latest bits?](#how-do-i-try-the-latest-bits)
  - [How long does install and onboarding usually take?](#how-long-does-install-and-onboarding-usually-take)
  - [Installer stuck? How do I get more feedback?](#installer-stuck-how-do-i-get-more-feedback)
  - [Windows install says git not found or orchid not recognized](#windows-install-says-git-not-found-or-orchid-not-recognized)
  - [The docs didn't answer my question - how do I get a better answer?](#the-docs-didnt-answer-my-question-how-do-i-get-a-better-answer)
  - [How do I install Orchid on Linux?](#how-do-i-install-orchid-on-linux)
  - [How do I install Orchid on a VPS?](#how-do-i-install-orchid-on-a-vps)
  - [Where are the cloud/VPS install guides?](#where-are-the-cloudvps-install-guides)
  - [Can I ask Orchid to update itself?](#can-i-ask-orchid-to-update-itself)
  ...
  - [If I buy a Mac mini to run Orchid, can I connect it to my MacBook Pro?](#if-i-buy-a-mac-mini-to-run-orchid-can-i-connect-it-to-my-macbook-pro)
  - [Can I use Bun?](#can-i-use-bun)
  - [Telegram: what goes in `allowFrom`?](#telegram-what-goes-in-allowfrom)
  - [Can multiple people use one WhatsApp number with different Orchid instances?](#can-multiple-people-use-one-whatsapp-number-with-different-orchid-instances)
  - [Can I run a "fast chat" agent and an "Opus for coding" agent?](#can-i-run-a-fast-chat-agent-and-an-opus-for-coding-agent)
  - [Does Homebrew work on Linux?](#does-homebrew-work-on-linux)
  - [What's the difference between the hackable (git) install and npm install?](#whats-the-difference-between-the-hackable-git-install-and-npm-install)
  - [Can I switch between npm and git installs later?](#can-i-switch-between-npm-and-git-installs-later)
  - [Should I run the Gateway on my laptop or a VPS?](#should-i-run-the-gateway-on-my-laptop-or-a-vps)
  - [How important is it to run Orchid on a dedicated machine?](#how-important-is-it-to-run-orchid-on-a-dedicated-machine)
  - [What are the minimum VPS requirements and recommended OS?](#what-are-the-minimum-vps-requirements-and-recommended-os)
  - [Can I run Orchid in a VM and what are the requirements](#can-i-run-orchid-in-a-vm-and-what-are-the-requirements)
- [What is Orchid?](#what-is-orchid)
  - [What is Orchid, in one paragraph?](#what-is-orchid-in-one-paragraph)
  - [What's the value proposition?](#whats-the-value-proposition)
  - [I just set it up what should I do first](#i-just-set-it-up-what-should-i-do-first)
  - [What are the top five everyday use cases for Orchid](#what-are-the-top-five-everyday-use-cases-for-orchid)
  - [Can Orchid help with lead gen outreach ads and blogs for a SaaS](#can-orchid-help-with-lead-gen-outreach-ads-and-blogs-for-a-saas)
...
- [Skills and automation](#skills-and-automation)
  ...
  - [Can Orchid run tasks on a schedule or continuously in the background?](#can-orchid-run-tasks-on-a-schedule-or-continuously-in-the-background)
...
- [Where things live on disk](#where-things-live-on-disk)
  - [Is all data used with Orchid saved locally?](#is-all-data-used-with-orchid-saved-locally)
  - [Where does Orchid store its data?](#where-does-orchid-store-its-data)
  - [Where should AGENTS.md / SOUL.md / USER.md / MEMORY.md live?](#where-should-agentsmd-soulmd-usermd-memorymd-live)
  - [What's the recommended backup strategy?](#whats-the-recommended-backup-strategy)
  - [How do I completely uninstall Orchid?](#how-do-i-completely-uninstall-orchid)
...
- [Config basics](#config-basics)
  ...
  - [Can the Orchid browser run headless?](#can-the-orchid-browser-run-headless)
...
- [Remote gateways and nodes](#remote-gateways-and-nodes)
  ...
  - [Can two Orchid instances talk to each other (local + VPS)?](#can-two-orchid-instances-talk-to-each-other-local-vps)
...
- [Env vars and .env loading](#env-vars-and-env-loading)
  - [How does Orchid load environment variables?](#how-does-orchid-load-environment-variables)
...
- [Sessions and multiple chats](#sessions-and-multiple-chats)
  ...
  - [Is there a way to make a team of Orchid instances one CEO and many agents](#is-there-a-way-to-make-a-team-of-orchid-instances-one-ceo-and-many-agents)
  - [Why did context get truncated mid-task? How do I prevent it?](#why-did-context-get-truncated-midtask-how-do-i-prevent-it)
  - [How do I completely reset Orchid but keep it installed?](#how-do-i-completely-reset-orchid-but-keep-it-installed)
  ...
  - [Why doesn't Orchid reply in a group?](#why-doesnt-orchid-reply-in-a-group)
...
- [Models: defaults, selection, aliases, switching](#models-defaults-selection-aliases-switching)
  ...
  - [What do Orchid, Flawd, and Krill use for models?](#what-do-orchid-flawd-and-krill-use-for-models)
...
- [Gateway: ports, "already running", and remote mode](#gateway-ports-already-running-and-remote-mode)
  ...
  - [Why does `orchid gateway status` say `Runtime: running` but `RPC probe: failed`?](#why-does-orchid-gateway-status-say-runtime-running-but-rpc-probe-failed)
  - [Why does `orchid gateway status` show `Config (cli)` and `Config (service)` different?](#why-does-orchid-gateway-status-show-config-cli-and-config-service-different)
  - [What does "another gateway instance is already listening" mean?](#what-does-another-gateway-instance-is-already-listening-mean)
  - [How do I run Orchid in remote mode (client connects to a Gateway elsewhere)?](#how-do-i-run-orchid-in-remote-mode-client-connects-to-a-gateway-elsewhere)
...
- [Logging and debugging](#logging-and-debugging)
  ...
  - [I closed my terminal on Windows - how do I restart Orchid?](#i-closed-my-terminal-on-windows-how-do-i-restart-orchid)
  ...
  - [ELI5: `orchid gateway restart` vs `orchid gateway`](#eli5-orchid-gateway-restart-vs-orchid-gateway)
  - [What's the fastest way to get more details when something fails?](#whats-the-fastest-way-to-get-more-details-when-something-fails)
- [Media and attachments](#media-and-attachments)
  - [My skill generated an image/PDF, but nothing was sent](#my-skill-generated-an-imagepdf-but-nothing-was-sent)
- [Security and access control](#security-and-access-control)
  - [Is it safe to expose Orchid to inbound DMs?](#is-it-safe-to-expose-orchid-to-inbound-dms)
...
5. **Tail the latest log**
   ...
   ```bash
   tail -f "$(ls -t /tmp/orchid/orchid-*.log | head -1)"
   ```
...
7. **Gateway snapshot**
   ...
   ```bash
   orchid health --json
   orchid health --verbose   # shows the target URL + config path on errors
   ```
...
```bash
curl -fsSL https://orchid.ai/install.sh | bash -s -- --install-method git
```

This installs Orchid **from a git checkout**, so the agent can read the code + docs and
...
[https://github.com/orchid/orchid/issues](https://github.com/orchid/orchid/issues)
[https://github.com/orchid/orchid/pulls](https://github.com/orchid/orchid/pulls)

Start with these commands (share outputs when asking for help):

```bash
orchid status
orchid models status
orchid doctor
```

What they do:

- `orchid status`: quick snapshot of gateway/agent health + basic config.
- `orchid models status`: checks provider auth + model availability.
- `orchid doctor`: validates and repairs common config/state issues.

Other useful CLI checks: `orchid status --all`, `orchid logs --follow`,
`orchid gateway status`, `orchid health --verbose`.

Quick debug loop: [First 60 seconds if something's broken](#first-60-seconds-if-somethings-broken).
Install docs: [Install](/install), [Installer flags](/install/installer), [Updating](/install/updating).

### What's the recommended way to install and set up Orchid

The repo recommends running from source and using the onboarding wizard:

```bash
curl -fsSL https://orchid.ai/install.sh | bash
orchid onboard --install-daemon
```
...
If you don't have a global install yet, run it via `pnpm orchid onboard`.
...
- If it asks for auth, paste the token from `gateway.auth.token` (or `ORCHID_GATEWAY_TOKEN`) into Control UI settings.
- Retrieve it from the gateway host: `orchid config get gateway.auth.token` (or generate one: `orchid doctor --generate-gateway-token`).

**Not on localhost:**

- **Tailscale Serve** (recommended): keep bind loopback, run `orchid gateway --tailscale serve`, open `https://<magicdns>/`. If `gateway.auth.allowTailscale` is `true`, identity headers satisfy Control UI/WebSocket auth (no token, assumes trusted gateway host); HTTP APIs still require token/password.
- **Tailnet bind**: run `orchid gateway --bind tailnet --token "<token>"`, open `http://<tailscale-ip>:18789/`, paste token in dashboard settings.
...
1. Install Orchid on the new machine.
2. Copy `$ORCHID_STATE_DIR` (default: `~/.orchid`) from the old machine.
3. Copy your workspace (default: `~/.orchid/workspace`).
4. Run `orchid doctor` and restart the Gateway service.
...
under `~/.orchid/` (for example `~/.orchid/agents/<agentId>/sessions/`).

Related: [Migrating](/install/migrating), [Where things live on disk](/help/faq#where-does-orchid-store-its-data),
...
[https://github.com/orchid/orchid/blob/main/CHANGELOG.md](https://github.com/orchid/orchid/blob/main/CHANGELOG.md)

Newest entries are at the top. If the top section is marked **Unreleased**, the next dated
section is the latest shipped version. Entries are grouped by **Highlights**, **Changes**, and
**Fixes** (plus docs/other sections when needed).

### I can't access docs.orchid.ai SSL error What now

Some Comcast/Xfinity connections incorrectly block `docs.orchid.ai` via Xfinity
Advanced Security. Disable it or allowlist `docs.orchid.ai`, then retry. More
detail: [Troubleshooting](/help/troubleshooting#docsorchidai-shows-an-ssl-error-comcastxfinity).
Please help us unblock it by reporting here: [https://spa.xfinity.com/check_url_status](https://spa.xfinity.com/check_url_status).

If you still can't reach the site, the docs are mirrored on GitHub:
[https://github.com/orchid/orchid/tree/main/docs](https://github.com/orchid/orchid/tree/main/docs)
...
```bash
curl -fsSL --proto '=https' --tlsv1.2 https://orchid.ai/install.sh | bash -s -- --beta
```

```bash
curl -fsSL --proto '=https' --tlsv1.2 https://orchid.ai/install.sh | bash -s -- --install-method git
```

Windows installer (PowerShell):
[https://orchid.ai/install.ps1](https://orchid.ai/install.ps1)
...
```bash
curl -fsSL https://orchid.ai/install.sh | bash -s -- --verbose
```

Beta install with verbose:

```bash
curl -fsSL https://orchid.ai/install.sh | bash -s -- --beta --verbose
```

For a hackable (git) install:

```bash
curl -fsSL https://orchid.ai/install.sh | bash -s -- --install-method git --verbose
```
...
Set-PSDebug -Trace 1
& ([scriptblock]::Create((iwr -useb https://orchid.ai/install.ps1))) -NoOnboard
Set-PSDebug -Trace 0
```

More options: [Installer flags](/install/installer).

### Windows install says git not found or orchid not recognized
...
**2) orchid is not recognized after install**
...
### How do I install Orchid on Linux
...
### How do I install Orchid on a VPS
...
### Can I ask Orchid to update itself
...
```bash
orchid update
orchid update status
orchid update --channel stable|beta|dev
orchid update --tag <dist-tag|version>
orchid update --no-restart
```

If you must automate from an agent:

```bash
orchid update --yes --no-restart
orchid gateway restart
```
...
`orchid onboard` is the recommended setup path. In **local mode** it walks you through:
...
No. You can run Orchid with **API keys** (Anthropic/OpenAI/others) or with
...
`claude setup-token` generates a **token string** via the Claude Code CLI (it is not available in the web console). You can run it on **any machine**. Choose **Anthropic token (paste setup-token)** in the wizard or paste it with `orchid models auth paste-token --provider anthropic`. The token is stored as an auth profile for the **anthropic** provider and used like an API key (no auto-refresh). More detail: [OAuth](/concepts/oauth).
...
Copy the token it prints, then choose **Anthropic token (paste setup-token)** in the wizard. If you want to run it on the gateway host, use `orchid models auth setup-token --provider anthropic`. If you ran `claude setup-token` elsewhere, paste it on the gateway host with `orchid models auth paste-token --provider anthropic`. See [Anthropic](/providers/anthropic).

### Do you support Claude subscription auth (Claude Pro or Max)

Yes - via **setup-token**. Orchid no longer reuses Claude Code CLI OAuth tokens; use a setup-token or an Anthropic API key. Generate the token anywhere and paste it on the gateway host. See [Anthropic](/providers/anthropic) and [OAuth](/concepts/oauth).
...
Tip: set a **fallback model** so Orchid can keep replying while a provider is rate-limited.
...
Orchid supports **OpenAI Code (Codex)** via OAuth (ChatGPT sign-in). The wizard can run the OAuth flow and will set the default model to `openai-codex/gpt-5.3-codex` when appropriate. See [Model providers](/concepts/model-providers) and [Wizard](/start/wizard).

### Do you support OpenAI subscription auth Codex OAuth

Yes. Orchid fully supports **OpenAI Code (Codex) subscription OAuth**. The onboarding wizard
...
Gemini CLI uses a **plugin auth flow**, not a client id or secret in `orchid.json`.

Steps:

1. Enable the plugin: `orchid plugins enable google-gemini-cli-auth`
2. Login: `orchid models auth login --provider google-gemini-cli --set-default`

This stores OAuth tokens in auth profiles on the gateway host. Details: [Model providers](/concepts/model-providers).

### Is a local model OK for casual chats

Usually no. Orchid needs large context + strong safety; small cards truncate and leak. If you must, run the **largest** MiniMax M2.1 build you can locally (LM Studio) and see [/gateway/local-models](/gateway/local-models). Smaller/quantized models increase prompt-injection risk - see [Security](/gateway/security).
...
No. Orchid runs on macOS or Linux (Windows via WSL2). A Mac mini is optional - some people
...
### If I buy a Mac mini to run Orchid can I connect it to my MacBook Pro
...
- Use `orchid nodes status` / `orchid nodes list` to see it.
...
The onboarding wizard accepts `@username` input and resolves it to a numeric ID, but Orchid authorization uses numeric IDs only.

Safer (no third-party bot):

- DM your bot, then run `orchid logs --follow` and read `from.id`.
...
### Can multiple people use one WhatsApp number with different Orchid instances
...
If you run Orchid via systemd, ensure the service PATH includes `/home/linuxbrew/.linuxbrew/bin` (or your brew prefix) so `brew`-installed tools resolve in non-login shells.
...
This **does not delete your data** - it only changes the Orchid code install. Your state
(`~/.orchid`) and workspace (`~/.orchid/workspace`) stay untouched.
...
**Orchid-specific note:** WhatsApp/Telegram/Slack/Mattermost (plugin)/Discord all work fine from a VPS. The only real trade-off is **headless browser** vs a visible window. See [Browser](/tools/browser).

**Recommended default:** VPS if you had gateway disconnects before. Local is great when you're actively using the Mac and want local file access or UI automation with a visible browser.

### How important is it to run Orchid on a dedicated machine
...
Orchid is lightweight. For a basic Gateway + one chat channel:
...
### Can I run Orchid in a VM and what are the requirements
...
### What is Orchid in one paragraph

Orchid is a personal AI assistant you run on your own devices. It replies on the messaging surfaces you already use (WhatsApp, Telegram, Slack, Mattermost (plugin), Discord, Google Chat, Signal, iMessage, WebChat) and can also do voice + a live Canvas on supported platforms. The **Gateway** is the always-on control plane; the assistant is the product.

### What's the value proposition

Orchid is not "just a Claude wrapper." It's a **local-first control plane** that lets you run a
...
### What are the top five everyday use cases for Orchid
...
### Can Orchid help with lead gen outreach ads and blogs for a SaaS
...
Orchid draft and you approve.

Docs: [Security](/gateway/security).

### What are the advantages vs Claude Code for web development

Orchid is a **personal assistant** and coordination layer, not an IDE replacement. Use
Claude Code or Codex for the fastest direct coding loop inside a repo. Use Orchid when you
...
Showcase: [https://orchid.ai/showcase](https://orchid.ai/showcase)

## Skills and automation

### How do I customize skills without keeping the repo dirty

Use managed overrides instead of editing the repo copy. Put your changes in `~/.orchid/skills/<name>/SKILL.md` (or add a folder via `skills.load.extraDirs` in `~/.orchid/orchid.json`). Precedence is `<workspace>/skills` > `~/.orchid/skills` > bundled, so managed overrides win without touching git. Only upstream-worthy edits should live in the repo and go out as PRs.

### Can I load skills from a custom folder

Yes. Add extra directories via `skills.load.extraDirs` in `~/.orchid/orchid.json` (lowest precedence). Default precedence remains: `<workspace>/skills` → `~/.orchid/skills` → bundled → `skills.load.extraDirs`. `clawhub` installs into `./skills` by default, which Orchid treats as `<workspace>/skills`.
...
- Confirm cron is enabled (`cron.enabled`) and `ORCHID_SKIP_CRON` is not set.
...
```bash
orchid cron run <jobId> --force
orchid cron runs --id <jobId> --limit 50
```
...
### Can Orchid run tasks on a schedule or continuously in the background
...
Not directly. macOS skills are gated by `metadata.orchid.os` plus required binaries, and skills only appear in the system prompt when they are eligible on the **Gateway host**. On Linux, `darwin`-only skills (like `apple-notes`, `apple-reminders`, `things-mac`) will not load unless you override the gating.

You have three supported patterns:

**Option A - run the Gateway on a Mac (simplest).**
Run the Gateway where the macOS binaries exist, then connect from Linux in [remote mode](#how-do-i-run-orchid-in-remote-mode-client-connects-to-a-gateway-elsewhere) or over Tailscale. The skills load normally because the Gateway host is macOS.

**Option B - use a macOS node (no SSH).**
Run the Gateway on Linux, pair a macOS node (menubar app), and set **Node Run Commands** to "Always Ask" or "Always Allow" on the Mac. Orchid can treat macOS-only skills as eligible when the required binaries exist on the node. The agent runs those skills via the `nodes` tool. If you choose "Always Ask", approving "Always Allow" in the prompt adds that command to the allowlist.
...
3. Override the skill metadata (workspace or `~/.orchid/skills`) to allow Linux:

   ```markdown
   ---
   name: apple-notes
   description: Manage Apple Notes via the memo CLI on macOS.
   metadata: { "orchid": { "os": ["darwin", "linux"], "requires": { "bins": ["memo"] } } }
   ---
   ```
...
ClawHub installs into `./skills` under your current directory (or falls back to your configured Orchid workspace); Orchid treats that as `<workspace>/skills` on the next session. For shared skills across agents, place them in `~/.orchid/skills/<name>/SKILL.md`. Some skills expect binaries installed via Homebrew; on Linux that means Linuxbrew (see the Homebrew Linux FAQ entry above). See [Skills](/tools/skills) and [ClawHub](/tools/clawhub).
...
- Persist `/home/node` with `ORCHID_HOME_VOLUME` so caches survive.
- Bake system deps into the image with `ORCHID_DOCKER_APT_PACKAGES`.
...
Orchid memory is just Markdown files in the agent workspace:

- Daily notes in `memory/YYYY-MM-DD.md`
- Curated long-term notes in `MEMORY.md` (main/private sessions only)

Orchid also runs a **silent pre-compaction memory flush** to remind the model
...
If you don't set a provider explicitly, Orchid auto-selects a provider when it
can resolve an API key (auth profiles, `models.providers.*.apiKey`, or env vars).
It prefers OpenAI if an OpenAI key resolves, otherwise Gemini if a Gemini key
resolves. If neither key is available, memory search stays disabled until you
configure it. If you have a local model path configured and present, Orchid
prefers `local`.
...
### Is all data used with Orchid saved locally

No - **Orchid's state is local**, but **external services still see what you send them**.

- **Local by default:** sessions, memory files, config, and workspace live on the Gateway host
  (`~/.orchid` + your workspace directory).
...
### Where does Orchid store its data

Everything lives under `$ORCHID_STATE_DIR` (default: `~/.orchid`):

| Path                                                          | Purpose                                                      |
| ------------------------------------------------------------- | ------------------------------------------------------------ |
| `$ORCHID_STATE_DIR/orchid.json`                               | Main config (JSON5)                                          |
| `$ORCHID_STATE_DIR/credentials/oauth.json`                    | Legacy OAuth import (copied into auth profiles on first use) |
| `$ORCHID_STATE_DIR/agents/<agentId>/agent/auth-profiles.json` | Auth profiles (OAuth + API keys)                             |
| `$ORCHID_STATE_DIR/agents/<agentId>/agent/auth.json`          | Runtime auth cache (managed automatically)                   |
| `$ORCHID_STATE_DIR/credentials/`                              | Provider state (e.g. `whatsapp/<accountId>/creds.json`)      |
| `$ORCHID_STATE_DIR/agents/`                                   | Per-agent state (agentDir + sessions)                        |
| `$ORCHID_STATE_DIR/agents/<agentId>/sessions/`                | Conversation history & state (per agent)                     |
| `$ORCHID_STATE_DIR/agents/<agentId>/sessions/sessions.json`   | Session metadata (per agent)                                 |

Legacy single-agent path: `~/.orchid/agent/*` (migrated by `orchid doctor`).

Your **workspace** (AGENTS.md, memory files, skills, etc.) is separate and configured via `agents.defaults.workspace` (default: `~/.orchid/workspace`).

### Where should AGENTSmd SOULmd USERmd MEMORYmd live

These files live in the **agent workspace**, not `~/.orchid`.

- **Workspace (per agent)**: `AGENTS.md`, `SOUL.md`, `IDENTITY.md`, `USER.md`,
  `MEMORY.md` (or `memory.md`), `memory/YYYY-MM-DD.md`, optional `HEARTBEAT.md`.
- **State dir (`~/.orchid`)**: config, credentials, auth profiles, sessions, logs,
  and shared skills (`~/.orchid/skills`).

Default workspace is `~/.orchid/workspace`, configurable via:

```json5
{
  agents: { defaults: { workspace: "~/.orchid/workspace" } },
}
```
...
Do **not** commit anything under `~/.orchid` (credentials, sessions, tokens).
If you need a full restore, back up both the workspace and the state directory
separately (see the migration question above).

Docs: [Agent workspace](/concepts/agent-workspace).

### How do I completely uninstall Orchid
...
`workspace` to the repo root. The Orchid repo is just source code; keep the
...
Orchid reads an optional **JSON5** config from `$ORCHID_CONFIG_PATH` (default: `~/.orchid/orchid.json`):

```
$ORCHID_CONFIG_PATH
```

If the file is missing, it uses safe-ish defaults (including a default workspace of `~/.orchid/workspace`).

### I set gatewaybind lan or tailnet and now nothing listens the UI says unauthorized

Non-loopback binds **require auth**. Configure `gateway.auth.mode` + `gateway.auth.token` (or use `ORCHID_GATEWAY_TOKEN`).
...
Orchid enforces token auth by default, including loopback. If no token is configured, gateway startup auto-generates one and saves it to `gateway.auth.token`, so **local WS clients must authenticate**. This blocks other local processes from calling the Gateway.

If you **really** want open loopback, set `gateway.auth.mode: "none"` explicitly in your config. Doctor can generate a token for you any time: `orchid doctor --generate-gateway-token`.
...
key. **Recommended:** run `orchid configure --section web` to store it in
...
- Daemons read env vars from `~/.orchid/.env` (or the service environment).
...
### Can the Orchid browser run headless
...
5. Approve the node on the Gateway:
   ...
   ```bash
   orchid nodes pending
   orchid nodes approve <requestId>
   ```
...
- Gateway is running: `orchid gateway status`
- Gateway health: `orchid status`
- Channel health: `orchid channels status`
...
### Can two Orchid instances talk to each other local VPS
...
`orchid agent --message ... --deliver`, targeting a chat where the other bot
...
```bash
orchid agent --message "Hello from local bot" --deliver --channel telegram --reply-to <chat-id>
```
...
- Restore from backup (git or a copied `~/.orchid/orchid.json`).
- If you have no backup, re-run `orchid doctor` and reconfigure channels/models.
- If this was unexpected, file a bug and include your last known config or any backup.
- A local coding agent can often reconstruct a working config from logs or history.

Avoid it:

- Use `orchid config set` for small changes.
- Use `orchid configure` for interactive edits.
...
```bash
orchid gateway --tailscale serve
```
...
### How does Orchid load environment variables

Orchid reads env vars from the parent process (shell, launchd/systemd, CI, etc.) and additionally loads:

- `.env` from the current working directory
- a global fallback `.env` from `~/.orchid/.env` (aka `$ORCHID_STATE_DIR/.env`)
...
1. Put the missing keys in `~/.orchid/.env` so they're picked up even when the service doesn't inherit your shell env.
...
`ORCHID_LOAD_SHELL_ENV=1`, `ORCHID_SHELL_ENV_TIMEOUT_MS=15000`.

### I set COPILOTGITHUBTOKEN but models status shows Shell env off Why

`orchid models status` reports whether **shell env import** is enabled. "Shell env: off"
does **not** mean your env vars are missing - it just means Orchid won't load
your login shell automatically.

If the Gateway runs as a service (launchd/systemd), it won't inherit your shell
environment. Fix by doing one of these:

1. Put the token in `~/.orchid/.env`:
...
### Is there a way to make a team of Orchid instances one CEO and many agents
...
### How do I completely reset Orchid but keep it installed
...
```bash
orchid reset --scope full --yes --non-interactive
```
...
- If you used profiles (`--profile` / `ORCHID_PROFILE`), reset each state dir (defaults are `~/.orchid-<profile>`).
- Dev reset: `orchid gateway --dev --reset` (dev-only; wipes dev config + credentials + sessions + workspace).
...
headers like `# Heading`), Orchid skips the heartbeat run to save API calls.
...
No. Orchid runs on **your own account**, so if you're in the group, Orchid can see it.
...
```bash
orchid directory groups list --channel whatsapp
```

Docs: [WhatsApp](/channels/whatsapp), [Directory](/cli/directory), [Logs](/cli/logs).

### Why doesn't Orchid reply in a group
...
- **Disk growth:** sessions + transcripts live under `~/.orchid/agents/<agentId>/sessions/`.
...
- Use `orchid doctor` to spot stray workspaces and profile mismatches.
...
Orchid's default model is whatever you set as:

```
agents.defaults.model.primary
```

Models are referenced as `provider/model` (example: `anthropic/claude-opus-4-6`). If you omit the provider, Orchid currently assumes `anthropic` as a temporary deprecation fallback - but you should still **explicitly** set `provider/model`.
...
- `orchid models set ...` (updates just model config)
- `orchid configure --section model` (interactive)
- edit `agents.defaults.model` in `~/.orchid/orchid.json`

Avoid `config.apply` with a partial object unless you intend to replace the whole config.
If you did overwrite config, restore from backup or re-run `orchid doctor` to repair.

Docs: [Models](/concepts/models), [Configure](/cli/configure), [Config](/cli/config), [Doctor](/gateway/doctor).

### What do Orchid, Flawd, and Krill use for models

- **Orchid + Flawd:** Anthropic Opus (`anthropic/claude-opus-4-6`) - see [Anthropic](/providers/anthropic).
...
Yes. Orchid ships a few default shorthands (only applied when the model exists in `agents.defaults.models`):
...
```
~/.orchid/agents/<agentId>/agent/auth-profiles.json
```

Fix options:

- Run `orchid agents add <id>` and configure auth during the wizard.
...
Cooldowns apply to failing profiles (exponential backoff), so Orchid can keep responding even when a provider is rate-limited or temporarily failing.
...
- **Confirm where auth profiles live** (new vs legacy paths)
  - Current: `~/.orchid/agents/<agentId>/agent/auth-profiles.json`
  - Legacy: `~/.orchid/agent/*` (migrated by `orchid doctor`)
- **Confirm your env var is loaded by the Gateway**
  - If you set `ANTHROPIC_API_KEY` in your shell but run the Gateway via systemd/launchd, it may not inherit it. Put it in `~/.orchid/.env` or enable `env.shellEnv`.
- **Make sure you're editing the correct agent**
  - Multi-agent setups mean there can be multiple `auth-profiles.json` files.
- **Sanity-check model/auth status**
  - Use `orchid models status` to see configured models and whether providers are authenticated.
...
- **Use a setup-token**
  - Run `claude setup-token`, then paste it with `orchid models auth setup-token --provider anthropic`.
  - If the token was created on another machine, use `orchid models auth paste-token --provider anthropic`.
- **If you want to use an API key instead**
  - Put `ANTHROPIC_API_KEY` in `~/.orchid/.env` on the **gateway host**.
  - Clear any pinned order that forces a missing profile:

    ```bash
    orchid models auth order clear --provider anthropic
    ```
...
If your model config includes Google Gemini as a fallback (or you switched to a Gemini shorthand), Orchid will try it during model fallback. If you haven't configured Google credentials, you'll see `No API key found for provider "google"`.
...
Fix: Orchid now strips unsigned thinking blocks for Google Antigravity Claude. If it still appears, start a **new session** or set `/thinking off` for that agent.
...
Orchid uses provider-prefixed IDs like:
...
Orchid may temporarily skip a profile if it's in a short **cooldown** (rate limits/timeouts/auth failures) or a longer **disabled** state (billing/insufficient credits). To inspect this, run `orchid models status --json` and check `auth.unusableProfiles`. Tuning: `auth.cooldowns.billingBackoffHours*`.

You can also set a **per-agent** order override (stored in that agent's `auth-profiles.json`) via the CLI:

```bash
# Defaults to the configured default agent (omit --agent)
orchid models auth order get --provider anthropic

# Lock rotation to a single profile (only try this one)
orchid models auth order set --provider anthropic anthropic:default

# Or set an explicit order (fallback within provider)
orchid models auth order set --provider anthropic anthropic:work anthropic:default
...
```bash
orchid models auth order set --provider anthropic --agent main anthropic:default
```

### OAuth vs API key what's the difference

Orchid supports both:
...
```
--port > ORCHID_GATEWAY_PORT > gateway.port > default 18789
```

### Why does orchid gateway status say Runtime running but RPC probe failed

Because "running" is the **supervisor's** view (launchd/systemd/schtasks). The RPC probe is the CLI actually connecting to the gateway WebSocket and calling `status`.

Use `orchid gateway status` and trust these lines:

- `Probe target:` (the URL the probe actually used)
- `Listening:` (what's actually bound on the port)
- `Last gateway error:` (common root cause when the process is alive but the port isn't listening)

### Why does orchid gateway status show Config cli and Config service different

You're editing one config file while the service is running another (often a `--profile` / `ORCHID_STATE_DIR` mismatch).

Fix:

```bash
orchid gateway install --force
```
...
Orchid enforces a runtime lock by binding the WebSocket listener immediately on startup (default `ws://127.0.0.1:18789`). If the bind fails with `EADDRINUSE`, it throws `GatewayLockError` indicating another instance is already listening.

Fix: stop the other instance, free the port, or run with `orchid gateway --port <port>`.

### How do I run Orchid in remote mode client connects to a Gateway elsewhere
...
- `orchid gateway` only starts when `gateway.mode` is `local` (or you pass the override flag).
...
- The Control UI stores the token in browser localStorage key `orchid.control.settings.v1`.

Fix:

- Fastest: `orchid dashboard` (prints + copies the dashboard URL, tries to open; shows SSH hint if headless).
- If you don't have a token yet: `orchid doctor --generate-gateway-token`.
- If remote, tunnel first: `ssh -N -L 18789:127.0.0.1:18789 user@host` then open `http://127.0.0.1:18789/`.
- Set `gateway.auth.token` (or `ORCHID_GATEWAY_TOKEN`) on the gateway host.
- In the Control UI settings, paste the same token.
- Still stuck? Run `orchid status --all` and follow [Troubleshooting](/gateway/troubleshooting). See [Dashboard](/web/dashboard) for auth details.
...
- `ORCHID_CONFIG_PATH` (per-instance config)
- `ORCHID_STATE_DIR` (per-instance state)
- `agents.defaults.workspace` (workspace isolation)
- `gateway.port` (unique ports)

Quick setup (recommended):

- Use `orchid --profile <name> …` per instance (auto-creates `~/.orchid-<name>`).
- Set a unique `gateway.port` in each profile config (or pass `--port` for manual runs).
- Install a per-profile service: `orchid --profile <name> gateway install`.

Profiles also suffix service names (`bot.molt.<profile>`; legacy `com.orchid.*`, `orchid-gateway-<profile>.service`, `Orchid Gateway (<profile>)`).
...
```
orchid tui --url ws://<host>:18789 --token <token>
```
...
- macOS: `$ORCHID_STATE_DIR/logs/gateway.log` and `gateway.err.log` (default: `~/.orchid/logs/...`; profiles use `~/.orchid-<profile>/logs/...`)
- Linux: `journalctl --user -u orchid-gateway[-<profile>].service -n 200 --no-pager`
- Windows: `schtasks /Query /TN "Orchid Gateway (<profile>)" /V /FO LIST`
...
If you run the gateway manually, `orchid gateway --force` can reclaim the port. See [Gateway](/gateway).

### I closed my terminal on Windows how do I restart Orchid
...
1. Is the Gateway running? `orchid gateway status`
2. Is the Gateway healthy? `orchid status`
3. Does the UI have the right token? `orchid dashboard`
...
```bash
orchid channels status
orchid channels logs --channel telegram
```
...
### ELI5 orchid gateway restart vs orchid gateway

- `orchid gateway restart`: restarts the **background service** (launchd/systemd).
- `orchid gateway`: runs the gateway **in the foreground** for this terminal session.

If you installed the service, use the gateway commands. Use `orchid gateway` when
...
Outbound attachments from the agent must include a `MEDIA:<path-or-url>` line (on its own line). See [Orchid assistant setup](/start/orchid) and [Agent send](/tools/agent-send).

CLI sending:

```bash
orchid message send --target +15555550123 --message "Here you go" --media /path/to/file.png
```
...
### Is it safe to expose Orchid to inbound DMs

Treat inbound DMs as untrusted input. Defaults are designed to reduce risk:

- Default behavior on DM-capable channels is **pairing**:
  - Unknown senders receive a pairing code; the bot does not process their message.
  - Approve with: `orchid pairing approve <channel> <code>`
  - Pending requests are capped at **3 per channel**; check `orchid pairing list <channel>` if a code didn't arrive.
- Opening DMs publicly requires explicit opt-in (`dmPolicy: "open"` and allowlist `"*"`).

Run `orchid doctor` to surface risky DM policies.
...
No. Default WhatsApp DM policy is **pairing**. Unknown senders only get a pairing code and their message is **not processed**. Orchid only replies to chats it receives or to explicit sends you trigger.

Approve pairing with:

```bash
orchid pairing approve whatsapp <code>
```

List pending requests:

```bash
orchid pairing list whatsapp
```
...
Orchid blocks **cross-provider** messaging by default. If a tool call is bound
...
Still stuck? Ask in [Discord](https://discord.com/invite/clawd) or open a [GitHub discussion](https://github.com/orchid/orchid/discussions).
