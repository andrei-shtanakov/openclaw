...
Orchid treats **wake words as a single global list** owned by the **Gateway**.
...
- `~/.orchid/settings/voicewake.json`

Shape:

```json
{ "triggers": ["orchid", "claude", "computer"], "updatedAtMs": 1730000000000 }
```
