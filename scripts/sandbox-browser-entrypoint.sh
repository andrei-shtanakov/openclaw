...
export DISPLAY=:1
export HOME=/tmp/orchid-home
export XDG_CONFIG_HOME="${HOME}/.config"
export XDG_CACHE_HOME="${HOME}/.cache"

CDP_PORT="${ORCHID_BROWSER_CDP_PORT:-${ORCHID_BROWSER_CDP_PORT:-9222}}"
CDP_SOURCE_RANGE="${ORCHID_BROWSER_CDP_SOURCE_RANGE:-${ORCHID_BROWSER_CDP_SOURCE_RANGE:-}}"
VNC_PORT="${ORCHID_BROWSER_VNC_PORT:-${ORCHID_BROWSER_VNC_PORT:-5900}}"
NOVNC_PORT="${ORCHID_BROWSER_NOVNC_PORT:-${ORCHID_BROWSER_NOVNC_PORT:-6080}}"
ENABLE_NOVNC="${ORCHID_BROWSER_ENABLE_NOVNC:-${ORCHID_BROWSER_ENABLE_NOVNC:-1}}"
HEADLESS="${ORCHID_BROWSER_HEADLESS:-${ORCHID_BROWSER_HEADLESS:-0}}"
ALLOW_NO_SANDBOX="${ORCHID_BROWSER_NO_SANDBOX:-${ORCHID_BROWSER_NO_SANDBOX:-0}}"
NOVNC_PASSWORD="${ORCHID_BROWSER_NOVNC_PASSWORD:-${ORCHID_BROWSER_NOVNC_PASSWORD:-}}"
