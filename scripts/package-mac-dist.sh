...
# Output:
# - dist/Orchid.app
# - dist/Orchid-<version>.zip
# - dist/Orchid-<version>.dmg
...
export BUNDLE_ID="${BUNDLE_ID:-ai.orchid.mac}"

"$ROOT_DIR/scripts/package-mac-app.sh"

APP="$ROOT_DIR/dist/Orchid.app"
if [[ ! -d "$APP" ]]; then
...
ZIP="$ROOT_DIR/dist/Orchid-$VERSION.zip"
DMG="$ROOT_DIR/dist/Orchid-$VERSION.dmg"
NOTARY_ZIP="$ROOT_DIR/dist/Orchid-$VERSION.notary.zip"
DSYM_ZIP="$ROOT_DIR/dist/Orchid-$VERSION.dSYM.zip"
