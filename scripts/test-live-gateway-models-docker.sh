...
docker run --rm -t \
  ...
  -e ORCHID_LIVE_GATEWAY_MODELS="${ORCHID_LIVE_GATEWAY_MODELS:-${ORCHID_LIVE_GATEWAY_MODELS:-all}}" \
  -e ORCHID_LIVE_GATEWAY_PROVIDERS="${ORCHID_LIVE_GATEWAY_PROVIDERS:-${ORCHID_LIVE_GATEWAY_PROVIDERS:-}}" \
  -e ORCHID_LIVE_GATEWAY_MODEL_TIMEOUT_MS="${ORCHID_LIVE_GATEWAY_MODEL_TIMEOUT_MS:-${ORCHID_LIVE_GATEWAY_MODEL_TIMEOUT_MS:-}}" \
