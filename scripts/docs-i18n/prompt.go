...
- Keep product names in English: Orchid, Pi, WhatsApp, Telegram, Discord, iMessage, Slack, Microsoft Teams, Google Chat, Signal.
- For the Orchid Gateway, use “Gateway 网关”.
