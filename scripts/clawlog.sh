...
show_usage() {
    cat << EOF
clawlog - Orchid Logging Utility

USAGE:
    clawlog [OPTIONS]

DESCRIPTION:
    View Orchid logs with full details (bypasses Apple's privacy redaction).
    Requires sudo access configured for /usr/bin/log command.

LOG FLOW ARCHITECTURE:
    Orchid logs flow through the macOS unified log (subsystem: ai.orchid).
