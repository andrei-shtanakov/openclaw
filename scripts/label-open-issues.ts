...
const STATE_FILE_PATH = join(CONFIG_BASE_DIR, "orchid", STATE_FILE_NAME);
      ...
      input: [
        {
          role: "system",
          content:
            "You classify GitHub issues and pull requests for Orchid. Respond with JSON only, no extra text.",
        },
        {
          role: "user",
          content: [
...
async function main() {
  ...
  logHeader("Orchid Issue Label Audit");
