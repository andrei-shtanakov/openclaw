...
function onRelayClosed(reason) {
  ...
  for (const tabId of tabs.keys()) {
    ...
    void chrome.action.setTitle({
      tabId,
      title: 'Orchid Browser Relay: disconnected (click to re-attach)',
    })
  }
  tabs.clear()
  tabBySession.clear()
...
async function attachTab(tabId, opts = {}) {
  ...
  void chrome.action.setTitle({
    tabId,
    title: 'Orchid Browser Relay: attached (click to detach)',
  })
...
async function detachTab(tabId, reason) {
  ...
  void chrome.action.setTitle({
    tabId,
    title: 'Orchid Browser Relay (click to attach/detach)',
  })
}
...
async function connectOrToggleForActiveTab() {
  ...
  void chrome.action.setTitle({
    tabId,
    title: 'Orchid Browser Relay: connecting to local relay…',
  })
  ...
  try {
    ...
    void chrome.action.setTitle({
      tabId,
      title: 'Orchid Browser Relay: relay not running (open options for setup)',
    })
