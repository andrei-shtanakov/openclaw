...
struct SettingsTab: View {
    ...
    @AppStorage("location.enabledMode") private var locationEnabledModeRaw: String = OrchidLocationMode.off.rawValue
    ...
    @State private var lastLocationModeRaw: String = OrchidLocationMode.off.rawValue
    ...
    private let gatewayLogger = Logger(subsystem: "ai.orchid.ios", category: "GatewaySettings")
    ...
    var body: some View {
        NavigationStack {
                ...
                Section("Device") {
                    DisclosureGroup("Features") {
                        ...
                        self.featureToggle(
                            ...
                            help: "Enables voice conversation mode with your connected Orchid agent.") { newValue in
                        ...
                        self.featureToggle(
                            ...
                            help: "Allows the gateway to request photos or short video clips while Orchid is foregrounded.")
                        ...
                        HStack(spacing: 8) {
                            ...
                            Button {
                                self.activeFeatureHelp = FeatureHelp(
                                    ...
                                    message: "Controls location permissions for Orchid. Off disables location tools, While Using enables foreground location, and Always enables background location.")
                            } label: {
                        ...
                        Picker("Location Access", selection: self.$locationEnabledModeRaw) {
                            Text("Off").tag(OrchidLocationMode.off.rawValue)
                            Text("While Using").tag(OrchidLocationMode.whileUsing.rawValue)
                            Text("Always").tag(OrchidLocationMode.always.rawValue)
                        }
                        .labelsHidden()
                        ...
                        self.featureToggle(
                            ...
                            help: "Keeps the screen awake while Orchid is open.")
                            ...
                            HStack(spacing: 8) {
                                ...
                                Button {
                                    self.activeFeatureHelp = FeatureHelp(
                                        ...
                                        message: "Appends this instruction when sharing content into Orchid from iOS.")
                                } label: {
                                    Image(systemName: "info.circle")
                                        .foregroundStyle(.secondary)
                                }
                    ...
                    DisclosureGroup("Device Info") {
                        ...
                        LabeledContent("Orchid", value: self.openClawVersionString())
                    }
                }
            }
            ...
            .onChange(of: self.locationEnabledModeRaw) { _, newValue in
                ...
                guard let mode = OrchidLocationMode(rawValue: newValue) else { return }
                Task {
