...
enum GatewaySettingsStore {
    private static let gatewayService = "ai.orchid.gateway"
    private static let nodeService = "ai.orchid.node"
    private static let talkService = "ai.orchid.talk"
...
enum GatewayDiagnostics {
    private static let logger = Logger(subsystem: "ai.orchid.ios", category: "GatewayDiag")
    private static let queue = DispatchQueue(label: "ai.orchid.gateway.diagnostics")
    ...
    private static var fileURL: URL? {
        FileManager.default.urls(for: .documentDirectory, in: .userDomainMask).first?
            .appendingPathComponent("orchid-gateway.log")
    }
