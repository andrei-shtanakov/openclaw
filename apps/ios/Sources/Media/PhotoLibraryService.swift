...
final class PhotoLibraryService: PhotosServicing {
    ...
    func latest(params: OrchidPhotosLatestParams) async throws -> OrchidPhotosLatestPayload {
        ...
        var results: [OrchidPhotoPayload] = []
        ...
        return OrchidPhotosLatestPayload(photos: results)
    }
    ...
    private static func renderAsset(
        ...
        maxWidth: Int,
        quality: Double,
        formatter: ISO8601DateFormatter) throws -> OrchidPhotoPayload
    {
