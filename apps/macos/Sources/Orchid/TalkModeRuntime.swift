...
actor TalkModeRuntime {
    ...
    private let logger = Logger(subsystem: "ai.orchid", category: "talk.runtime")
    private let ttsLogger = Logger(subsystem: "ai.orchid", category: "talk.tts")
    ...
    private func latestAssistantText(sessionKey: String, since: Double? = nil) async -> String? {
        do {
            ...
            let decoded: [OrchidChatMessage] = messages.compactMap { item in
