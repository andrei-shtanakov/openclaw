...
enum AgentWorkspace {
    private static let logger = Logger(subsystem: "ai.orchid", category: "workspace")
    ...
    static func resolveWorkspaceURL(from userInput: String?) -> URL {
        ...
        if trimmed.isEmpty { return OrchidConfigFile.defaultWorkspaceURL() }
