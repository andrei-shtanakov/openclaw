...
final class AppState {
    ...
    init(preview: Bool = false) {
        ...
        let configRoot = OrchidConfigFile.loadDict()
    ...
    private func startConfigWatcher() {
        let configUrl = OrchidConfigFile.url()
    ...
    private func syncGatewayConfigIfNeeded() {
        ...
        Task { @MainActor in
            ...
            var root = OrchidConfigFile.loadDict()
            ...
            OrchidConfigFile.saveDict(root)
        }
    }
...
extension AppState {
    static var preview: AppState {
        ...
        state.remoteProjectRoot = "~/Projects/orchid"
        state.remoteCliPath = ""
        return state
    }
}
