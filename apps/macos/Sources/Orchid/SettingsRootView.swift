...
struct SettingsRootView: View {
    ...
    var body: some View {
        ...
        .onReceive(NotificationCenter.default.publisher(for: .orchidSelectSettingsTab)) { note in
    ...
    private var nixManagedBanner: some View {
        ...
        let configPath = self.snapshotPaths.configPath ?? OrchidPaths.configURL.path
        let stateDir = self.snapshotPaths.stateDir ?? OrchidPaths.stateDirURL.path
...
extension Notification.Name {
    static let orchidSelectSettingsTab = Notification.Name("orchidSelectSettingsTab")
}
