...
struct AboutSettings: View {
    ...
    var body: some View {
        VStack(spacing: 8) {
            ...
            Button {
                if let url = URL(string: "https://github.com/orchid/orchid") {
            ...
            VStack(alignment: .center, spacing: 6) {
                AboutLinkRow(
                    ...
                    title: "GitHub",
                    url: "https://github.com/orchid/orchid")
                AboutLinkRow(icon: "globe", title: "Website", url: "https://orchid.ai")
    ...
    private var buildTimestamp: String? {
        guard
            let raw =
            (Bundle.main.object(forInfoDictionaryKey: "OrchidBuildTimestamp") as? String) ??
            (Bundle.main.object(forInfoDictionaryKey: "OrchidBuildTimestamp") as? String)
        else { return nil }
    ...
    private var gitCommit: String {
        (Bundle.main.object(forInfoDictionaryKey: "OrchidGitCommit") as? String) ??
            (Bundle.main.object(forInfoDictionaryKey: "OrchidGitCommit") as? String) ??
            "unknown"
    }
