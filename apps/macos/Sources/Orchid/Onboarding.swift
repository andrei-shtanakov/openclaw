...
enum UIStrings {
    static let welcomeTitle = "Welcome to Orchid"
}
...
final class OnboardingController {
    ...
    func show() {
        if ProcessInfo.processInfo.isNixMode {
            ...
            UserDefaults.standard.set(true, forKey: "orchid.onboardingSeen")
...
struct OnboardingView: View {
    ...
    @State var anthropicAuthDetectedStatus: OrchidOAuthStore.AnthropicOAuthStatus = .missingFile
    ...
    @State var onboardingChatModel: OrchidChatViewModel
    ...
    var devLinkCommand: String {
        ...
        return "npm install -g orchid@\(version)"
    }
            ...
            filterLocalGateways: false))
    {
        ...
        self._onboardingChatModel = State(
            initialValue: OrchidChatViewModel(
