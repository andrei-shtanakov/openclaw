...
enum OrchidConfigFile {
    private static let logger = Logger(subsystem: "ai.orchid", category: "config")
    ...
    static func stateDirURL() -> URL {
        OrchidPaths.stateDirURL
    }

    static func defaultWorkspaceURL() -> URL {
        OrchidPaths.workspaceURL
    }
    ...
    private static func appendConfigWriteAudit(_ fields: [String: Any]) {
        var record: [String: Any] = [
            ...
            "source": "macos-orchid-config-file",
            "event": "config.write",
