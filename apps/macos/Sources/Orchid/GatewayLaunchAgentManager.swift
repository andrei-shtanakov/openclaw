...
enum GatewayLaunchAgentManager {
    private static let logger = Logger(subsystem: "ai.orchid", category: "gateway.launchd")
    private static let disableLaunchAgentMarker = ".orchid/disable-launchagent"
...
extension GatewayLaunchAgentManager {
    ...
    {
        let command = CommandResolver.orchidCommand(
            subcommand: "gateway",
