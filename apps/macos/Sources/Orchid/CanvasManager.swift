...
final class CanvasManager {
    ...
    private static let logger = Logger(subsystem: "ai.orchid", category: "CanvasManager")
    ...
    private nonisolated static let canvasRoot: URL = {
        ...
        return base.appendingPathComponent("Orchid/canvas", isDirectory: true)
    }()
    ...
    private static func resolveA2UIHostUrl(from raw: String?) -> String? {
        ...
        return base.appendingPathComponent("__orchid__/a2ui/").absoluteString + "?platform=macos"
    }
