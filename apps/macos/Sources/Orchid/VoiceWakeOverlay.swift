...
final class VoiceWakeOverlayController {
    ...
    let logger = Logger(subsystem: "ai.orchid", category: "voicewake.overlay")
    let enableUI: Bool

    /// Keep the voice wake overlay above any other Orchid windows, but below the system’s pop-up menus.
