...
public typealias OrchidPlatformImage = NSImage
#elseif canImport(UIKit)
import UIKit

public typealias OrchidPlatformImage = UIImage
#endif

public struct OrchidChatUsageCost: Codable, Hashable, Sendable {
...
public struct OrchidChatUsage: Codable, Hashable, Sendable {
    public let input: Int?
    public let output: Int?
    public let cacheRead: Int?
    public let cacheWrite: Int?
    public let cost: OrchidChatUsageCost?
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.cost = try container.decodeIfPresent(OrchidChatUsageCost.self, forKey: .cost)
        self.total =
...
public struct OrchidChatMessageContent: Codable, Hashable, Sendable {
...
public struct OrchidChatMessage: Codable, Identifiable, Sendable {
    public var id: UUID = .init()
    public let role: String
    public let content: [OrchidChatMessageContent]
    public let timestamp: Double?
    public let toolCallId: String?
    public let toolName: String?
    public let usage: OrchidChatUsage?
    ...
    public init(
        id: UUID = .init(),
        role: String,
        content: [OrchidChatMessageContent],
        timestamp: Double?,
        toolCallId: String? = nil,
        toolName: String? = nil,
        usage: OrchidChatUsage? = nil,
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.usage = try container.decodeIfPresent(OrchidChatUsage.self, forKey: .usage)
        self.stopReason = try container.decodeIfPresent(String.self, forKey: .stopReason)

        if let decoded = try? container.decode([OrchidChatMessageContent].self, forKey: .content) {
...
public struct OrchidChatHistoryPayload: Codable, Sendable {
...
public struct OrchidSessionPreviewItem: Codable, Hashable, Sendable {
    public let role: String
    public let text: String
}

public struct OrchidSessionPreviewEntry: Codable, Sendable {
    public let key: String
    public let status: String
    public let items: [OrchidSessionPreviewItem]
}

public struct OrchidSessionsPreviewPayload: Codable, Sendable {
    public let ts: Int
    public let previews: [OrchidSessionPreviewEntry]

    public init(ts: Int, previews: [OrchidSessionPreviewEntry]) {
        self.ts = ts
        self.previews = previews
    }
}

public struct OrchidChatSendResponse: Codable, Sendable {
    public let runId: String
    public let status: String
}

public struct OrchidChatEventPayload: Codable, Sendable {
    public let runId: String?
    public let sessionKey: String?
...
public struct OrchidAgentEventPayload: Codable, Sendable, Identifiable {
...
public struct OrchidChatPendingToolCall: Identifiable, Hashable, Sendable {
...
public struct OrchidGatewayHealthOK: Codable, Sendable {
    public let ok: Bool?
}

public struct OrchidPendingAttachment: Identifiable {
    public let id = UUID()
    public let url: URL?
    ...
    public let mimeType: String
    public let type: String
    public let preview: OrchidPlatformImage?
...
public struct OrchidChatAttachmentPayload: Codable, Sendable, Hashable {
    public let type: String
    public let mimeType: String
    public let fileName: String
