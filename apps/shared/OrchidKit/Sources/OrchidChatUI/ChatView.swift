...
@MainActor
public struct OrchidChatView: View {
    public enum Style {
        case standard
        case onboarding
    }

    @State private var viewModel: OrchidChatViewModel
    ...
    private var visibleMessages: [OrchidChatMessage] {
        let base: [OrchidChatMessage]
    ...
    private func mergeToolResults(in messages: [OrchidChatMessage]) -> [OrchidChatMessage] {
    ...
    private func isToolResultMessage(_ message: OrchidChatMessage) -> Bool {
        let role = message.role.lowercased()
        return role == "toolresult" || role == "tool_result"
    }

    private func toolCallIds(in message: OrchidChatMessage) -> Set<String> {
        var ids = Set<String>()
    ...
    private func toolResultText(from message: OrchidChatMessage) -> String {
