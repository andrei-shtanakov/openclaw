...
public actor GatewayNodeSession {
    private let logger = Logger(subsystem: "ai.orchid", category: "node.gateway")
    ...
    static func invokeWithTimeout(
        ...
        let timeoutLogger = Logger(subsystem: "ai.orchid", category: "node.gateway")
        let timeout: Int = {
    ...
    private func decodeInvokeRequest(from payload: OrchidProtocol.AnyCodable) throws -> NodeInvokeRequestPayload {
        do {
