...
public enum OrchidTalkCommand: String, Codable, Sendable {
...
public struct OrchidTalkPTTStartPayload: Codable, Sendable, Equatable {
...
public struct OrchidTalkPTTStopPayload: Codable, Sendable, Equatable {
    public var captureId: String
