...
public enum OrchidCanvasA2UICommand: String, Codable, Sendable {
...
public struct OrchidCanvasA2UIPushParams: Codable, Sendable, Equatable {
...
public struct OrchidCanvasA2UIPushJSONLParams: Codable, Sendable, Equatable {
